# 00 — Preflight: Create Knowledge Database

> Written 2026-08-05 by the orchestrator, reusing the toolchain facts verified end-to-end this session on the same repo/module (Podman backend, both test tiers green). Deterministic for this repo.
...
./mvnw test -Dtest=CreateKnowledgeDatabaseServiceTest#methodName
```
